...
#endif
            //TODO_23 
            s = searchSet(SHOT_BEGIN, SHOT_END, moveShot1, obj->pos);
            if (s != NULL)
            {
...
//******************************************************************************
            ...
            {
                OBJ2D* s = NULL;
                s = searchSet(SHOT_BEGIN, SHOT_END, moveShot0, obj->pos);
                if (s)
                {
                    s->area = player.area;
                    s->angle = obj->angle;           
            ...
            {
                OBJ2D* s = NULL;
                s = searchSet(SHOT_BEGIN, SHOT_END, moveShot0_2, obj->pos);
                if (s)
                {
                    s->area = player.area;
                    s->angle = obj->angle;
            ...
            {
                OBJ2D* s = NULL;
                s = searchSet(SHOT_BEGIN, SHOT_END, moveShot0_3, obj->pos);
                if (s)
                {
                    s->area = player.area;
                    s->angle = obj->angle;
            ...
            {
                OBJ2D* s = NULL;
                s = searchSet(SHOT_BEGIN, SHOT_END, moveShot0_4, obj->pos);
                if (s)
                {
                    s->area = player.area;
                    s->angle = obj->angle;
...
//******************************************************************************
         ...
         /*   TODO_26*/
            ...
            if (obj->pos.y < (SCREEN_H / 2)&&(f==1))
            {

                for (int i = 0; i < 24; i++)
                {
                    OBJ2D* s = searchSet(SHOT_BEGIN, SHOT_END, moveShot2, obj->pos);
                    
                    if (s == NULL) break;

                    s->area = player.area;
                    s->angle =ToRadian( i * 15.0f);
